...
import static com.classwork.vidoeplayer.YoutubePlayer.BUFFERING;
import static com.classwork.vidoeplayer.YoutubePlayer.CUED;
import static com.classwork.vidoeplayer.YoutubePlayer.ENDED;
import static com.classwork.vidoeplayer.YoutubePlayer.PAUSED;
import static com.classwork.vidoeplayer.YoutubePlayer.PLAYING;
import static com.classwork.vidoeplayer.YoutubePlayer.UNSTARTED;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initMultiPlayers() {
        ...
        webYouTube = new YoutubePlayer(MainActivity.this);
    ...
    private void setMasterJubaPlayerListener() {
        ...
        webYouTube.setCurrentTimeListener(new YoutubePlayer.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                currentSeconds = (int) n;
            }
        }); //TODO: Put this in player view itself
        webYouTube.setDurationListener(new YoutubePlayer.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                videoDuration = (int) n;
            }
        }); //TODO: Put this in player view itself
        webYouTube.setVideoLoadedFractionListener(new YoutubePlayer.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                videoBuffered = n;
            }
